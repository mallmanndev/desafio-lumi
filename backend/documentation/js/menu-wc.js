                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/InvoiceValue.html" data-type="entity-link" >InvoiceValue</a>
                            </li>
                            <li class="link">
                                <a href="classes/ReadInvoiceUseCase.html" data-type="entity-link" >ReadInvoiceUseCase</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
